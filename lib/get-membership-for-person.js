...
module.exports = uid => {
  ...
  return myGroups.reduce((accumulator, current) => {
    ...
    return accumulator
  }, { groupIds: [], schoolIds: [], skoleeierIds: [], ordenIds: [], atferdIds: [], fagIds: [], basisgruppeIds: [], kontaktlarergruppeIds: [], undervisningsgruppeIds: [], utdanningsprogramIds: [], programomraadeIds: [] })
}
