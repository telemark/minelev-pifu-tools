...
module.exports = uid => {
  ...
  return myGroups.reduce((accumulator, current) => {
    ...
    return accumulator
  }, { groupIds: [], schoolIds: [], basisgruppeIds: [], basisgruppeNames: [], kontaktlarergruppeIds: [], undervisningsgruppeIds: [], undervisningsgruppeNames: [], utdanningsprogramIds: [], programomraadeIds: [] })
}
